 ...
 */
public class YugabyteDBIntervalSecondJdbcType implements AdjustableJdbcType {

    public static final YugabyteDBIntervalSecondJdbcType INSTANCE = new YugabyteDBIntervalSecondJdbcType();
    ...
    static {
        ...
        try {
            pgIntervalClass = ReflectHelper.classForName(
                    "com.yugabyte.util.PGInterval",
                    YugabyteDBIntervalSecondJdbcType.class
            );
